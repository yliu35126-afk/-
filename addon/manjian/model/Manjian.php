...
//                            $present_info = model('promotion_present')->getInfo([ ['present_id', '=', $present['present_id']] ], '*');
    ...
    public function getGoodsManjianInfo($goods_id, $site_id = 0)
    {
        ...
        $first_info = model('promotion_manjian')->getFirstData($condition, 'manjian_id,site_id,manjian_name,type,manjian_type,goods_ids,status,start_time,end_time,rule_json', 'create_time desc');
        if (!empty($first_info)) {
