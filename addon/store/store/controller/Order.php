...
class Order extends BaseStore
{
    ...
    private function handleItem($data){
        $data['province_name'] = model('area')->getInfo(['id' => $data['province_id']])['name'];
        $data['city_name'] = model('area')->getInfo(['id' => $data['city_id']])['name'];
        $data['district_name'] = model('area')->getInfo(['id' => $data['district_id']])['name'];
