...
var seckillTopConHtml = '<div class="goods-head">';
	...
	seckillTopConHtml +=		'<div class="time">12点场<span class="hour">02</span>:<span class="minute">00</span>:<span class="second">00</span></div>';
	...
	seckillTopConHtml +=			'<span style="color: #8662FD;">查看</span>';
	seckillTopConHtml +=			'<span style="color: #627BFD;">更多</span>';
	seckillTopConHtml +=		'</span>';
	...
	seckillTopConHtml +=		'<span>';
	seckillTopConHtml +=			'<span style="color: #FF7B91;">查看</span>';
	seckillTopConHtml +=			'<span style="color: #FF5151;">更多</span>';
	seckillTopConHtml +=		'</span>';
	...
	seckillTopConHtml +=		'<span>';
	seckillTopConHtml +=			'<span style="color: #12D0AE;">查看</span>';
	seckillTopConHtml +=			'<span style="color: #0ECFD3;">更多</span>';
	seckillTopConHtml +=		'</span>';
	...
	seckillTopConHtml +=		'<span>';
	seckillTopConHtml +=			'<span style="color: #FEB632;">查看</span>';
	seckillTopConHtml +=			'<span style="color: #FE6232;">更多</span>';
	seckillTopConHtml +=		'</span>';
	seckillTopConHtml +=		'<i class="iconfont iconyoujiantou" style="color: #FE6232;"></i>';
	seckillTopConHtml +=	'</div>';

	seckillTopConHtml +=	'<div class="more yellow" v-if="data.bgSelect==\'white\'">';
	seckillTopConHtml +=		'<span>';
	seckillTopConHtml +=			'<span style="color: #888;background: none;-webkit-text-fill-color: initial;">查看</span>';
	seckillTopConHtml +=			'<span style="color: #888;background: none;-webkit-text-fill-color: initial;">更多</span>';
	seckillTopConHtml +=		'</span>';
	seckillTopConHtml +=		'<i class="iconfont iconyoujiantou" style="color: #888;background: none;-webkit-text-fill-color: initial;"></i>';
	seckillTopConHtml +=	'</div>';
	seckillTopConHtml +='</div>';
