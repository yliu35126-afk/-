        ...
        if ($local_info[ 'area_type' ] == 1 || $local_info[ 'area_type' ] == 2) {
            ...
            if ($local_info[ 'area_type' ] == 1) {
                ...
                if(empty($latitude) || empty($longitude)){
                    return $this->error([ 'code' => 13 ], '收货地址定位信息缺失，请重新设置收货地址');
                }
                if(empty($shop_latitude) || empty($shop_latitude)){
                    return $this->error([ 'code' => 13 ], '商家['.$shop_info['site_name'].']地址信息未完善，请联系店铺管理员');
                }
