...
var textFontSizeHtml = '<div class="layui-form-item ns-icon-radio">';
	...
	textFontSizeHtml +=				 `<i :class="['iconfont', item.src]"></i>`;
	textFontSizeHtml +=			 '</li>';
	textFontSizeHtml +=		 '</ul>';
...
Vue.component("text-font-size", {
	...
	created: function () {
		...
		if (this.data.max == 12) {
			this.list = [{label: "小", value: "12", src: "icona-copy-copy"}];
		} else if (this.data.max == 14) {
			this.list = [
				{label: "小", value: "12", src: "icona-copy-copy"},
				{label: "中", value: "14", src: "icona-copy"}
			]
		} else {
			this.list = [
				{label: "小", value: "12", src: "icona-copy-copy"},
				{label: "中", value: "14", src: "icona-copy"},
				{label: "大", value: "16", src: "icona"}
			];
		}
	},
	watch: {
